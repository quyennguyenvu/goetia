...
- **Persisted settings** — order, muted, disabled, neverHibernate, zoom, theme, railPosition, closeToTray, launchAtLogin, globalMuted, globalMutedUntil, mutedUntil, downloads. Impl: `src/main/settings.ts`. Verified: `settings.test.ts`.
